      ...
      <div className="w-full max-w-sm overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-slate-200">
        ...
        <div className="p-7">
          <p className="text-sm text-slate-500">
            Enter your email and the league invite code — we&apos;ll email you a sign-in link. Open it on this
            device and you&apos;ll stay signed in here.
          </p>

          {state.ok ? (
            <div className="mt-6 rounded-lg border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-700">
              Check your inbox — a sign-in link is on its way. ✉️ Open it on the device you want to use, and that
